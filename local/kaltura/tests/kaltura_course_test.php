...
class kaltura_course_testcase extends advanced_testcase {
    ...
    public function test_search_course() {
        ...
        $course1 = $this->getDataGenerator()->create_course(array('idnumber' => 'id1', 'fullname' => 'course10', 'shortname' => 'crs1'));
        $course2 = $this->getDataGenerator()->create_course(array('idnumber' => 'id2', 'fullname' => 'course11', 'shortname' => 'crs2'));
        $course3 = $this->getDataGenerator()->create_course(array('idnumber' => 'id3', 'fullname' => 'course20', 'shortname' => 'crs3'));
        ...
        foreach ($courses as $course) {
            ...
            assign_capability('local/kaltura:view_report', CAP_ALLOW, $role->id, $coursecontext);
        }
     ...
     */
    function test_recent_course_history_listing($expected) {
        global $DB;

        $user = $this->getDataGenerator()->create_user();
        $this->setUser($user);

        $course1 = $this->getDataGenerator()->create_course(array('idnumber' => 'id1', 'fullname' => 'course1', 'shortname' => 'crs1'));
