...
$string['downloadtextformat_help'] = 'Si vous avez besoin de traiter les réponses à un questionnaire en dehors de Moodle 
dans un logiciel comme Excel, le tableur Calc d\'Open Office ou un logiciel de statistiques, vous pouvez exporter les données au format texte.';
...
Lorsque vous arrivez sur la page Toutes les réponses, par défaut toutes les réponses sont triées dans l\'ordre où les choix ont été entrés lors de la création des questions.
Vous pouvez alors effectuer des tris par ordre descendant ou ascendant.';
...
$string['respondenteligible_help'] = 'Décidez si tout le monde peut répondre au questionnaire 
ou seulement les participants ayant tel ou tel rôle 
dans le contexte du questionnaire.';
...
$string['resume_help'] = 'Cette option permet aux étudiants de sauvegarder leurs réponses à un questionnaire avant de les soumettre. Les étudiants peuvent commencer à répondre, 
sauvegarder l\'état d\'avancement, et reprendre le questionnaire plus tard à leur convenance, pour reprendre au point où ils en étaient. Ceci peut se révéler utile pour un questionnaire particulièrement long.';
